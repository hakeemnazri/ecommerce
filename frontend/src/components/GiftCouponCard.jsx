...
import { selectCoupon, selectIsCouponApplied } from '../../redux/cartSlice';
import { useGetCoupon } from '../../hooks/useCart';

function GiftCouponCard() {
  const coupon = useSelector(selectCoupon)
  const isCouponApplied = useSelector(selectIsCouponApplied)
  const [userInputCode, setUserInputCode] = useState("")
     const {getCouponHook} =useGetCoupon()

  useEffect(()=>{
	getCouponHook()
	setUserInputCode(coupon?.code)
  },[getCouponHook, coupon?.code])
